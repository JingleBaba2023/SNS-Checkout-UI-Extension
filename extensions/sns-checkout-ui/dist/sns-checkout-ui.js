(() => {
  ...
  // extensions/sns-checkout-ui/node_modules/react/cjs/react.development.js
  var require_react_development = __commonJS({
    "extensions/sns-checkout-ui/node_modules/react/cjs/react.development.js"(exports, module) {
      "use strict";
      if (true) {
        (function() {
          "use strict";
  ...
  // extensions/sns-checkout-ui/node_modules/react/index.js
  var require_react = __commonJS({
    "extensions/sns-checkout-ui/node_modules/react/index.js"(exports, module) {
      "use strict";
      if (false) {
        module.exports = null;
      } else {
  ...
  // extensions/sns-checkout-ui/node_modules/react/cjs/react-jsx-runtime.development.js
  var require_react_jsx_runtime_development = __commonJS({
    "extensions/sns-checkout-ui/node_modules/react/cjs/react-jsx-runtime.development.js"(exports) {
      "use strict";
      if (true) {
        (function() {
          "use strict";
  ...
  // extensions/sns-checkout-ui/node_modules/react/jsx-runtime.js
  var require_jsx_runtime = __commonJS({
    "extensions/sns-checkout-ui/node_modules/react/jsx-runtime.js"(exports, module) {
      "use strict";
      if (false) {
        module.exports = null;
      } else {
  ...
  // extensions/sns-checkout-ui/src/Checkout.jsx
  ...
  // extensions/sns-checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/render.mjs
  var import_react6 = __toESM(require_react(), 1);

  // extensions/sns-checkout-ui/node_modules/@remote-ui/react/build/esm/render.mjs
  var import_react2 = __toESM(require_react(), 1);

  // extensions/sns-checkout-ui/node_modules/@remote-ui/react/build/esm/reconciler.mjs
  ...
  // extensions/sns-checkout-ui/node_modules/@remote-ui/react/build/esm/context.mjs
  ...
  // extensions/sns-checkout-ui/node_modules/@remote-ui/react/build/esm/components.mjs
  var import_react4 = __toESM(require_react(), 1);
  var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);

  // extensions/sns-checkout-ui/node_modules/@remote-ui/react/build/esm/hooks/render.mjs
  ...
  // extensions/sns-checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/context.mjs
...
${errorInfo.componentStack}`);
  ...
  // extensions/sns-checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/Banner/Banner.mjs
  var Banner2 = createRemoteReactComponent(Banner);

  // extensions/sns-checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/api.mjs
  var import_react9 = __toESM(require_react(), 1);

  // extensions/sns-checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/errors.mjs
  ...
  // extensions/sns-checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/subscription.mjs
  ...
  // extensions/sns-checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/buyer-journey.mjs
  ...
  // extensions/sns-checkout-ui/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/cart-lines.mjs
  ...
  function App() {
    ...
    const [showError, setShowError] = (0, import_react12.useState)(false);
    const [adding, setAdding] = (0, import_react12.useState)(false);
    const [freeProductsCount, updateFreeProductsCount] = (0, import_react12.useState)(0);
          ...
          errors: [
            {
              ...
              message: "Only Free Products Available In Cart"
            }
          ]
        } : {
          behavior: "allow"
    ...
    (0, import_react12.useEffect)(() => {
      (() => __async(this, null, function* () {
        const curatedLinesData = yield Promise.all(lines.map((line) => __async(this, null, function* () {
          var _a, _b;
          const { data: { product } } = yield fetchProduct(line.merchandise.product.id);
          if (!product)
            return {};
          const curatedCollection = (_b = (_a = product == null ? void 0 : product.collections) == null ? void 0 : _a.nodes) == null ? void 0 : _b.map((item) => item.id);
          const tags = product == null ? void 0 : product.tags;
          return __spreadValues({ tags, collections: curatedCollection }, line);
        })));
    ...
    (0, import_react12.useEffect)(() => {
      if (lineItemsData.length > 0) {
        debugger;
        let freeProductsCount2 = 0;
        let isFreeProduct = false;
        let doesComplimentaryProductExist = false;
        lineItemsData.forEach((line) => __async(this, null, function* () {
          var _a;
          let isComplimentaryProduct = false;
          doesComplimentaryProductExist = false;
          (_a = line == null ? void 0 : line.attributes) == null ? void 0 : _a.forEach((attr) => {
            if (attr.key == "_attribution" && attr.value == "Rebuy Tiered Progress Bar") {
              isFreeProduct = true;
              freeProductsCount2 = freeProductsCount2 + 1;
            }
          ...
          isFreeProduct && line.quantity >= 2 && (yield updateCart(line));
          updateFreeProductsCount(freeProductsCount2);
          const { tags = [] } = line || {};
          if (!isFreeProduct && tags.find((item) => item == "free_gift")) {
            const data = yield removeCartItem(line);
            if (data.type == "error") {
    ...
    (0, import_react12.useEffect)(() => {
      ...
      if (removedComplimentaryProducts) {
        (() => __async(this, null, function* () {
          const { data: { page: { complimentarySettings: { value: metaObjectData } } } } = yield fetchPage();
          const metaObjectJson = JSON.parse(metaObjectData);
          const complimentarySettings = yield Promise.all(metaObjectJson.map((metaobject) => __async(this, null, function* () {
            return yield fetchMetaobject(metaobject);
          })));
          const curatedData = complimentarySettings.map((setting) => {
            var _a, _b, _c, _d;
            const collection = (_b = (_a = setting == null ? void 0 : setting.data) == null ? void 0 : _a.metaobject) == null ? void 0 : _b.collection.value;
            const variant = (_d = (_c = setting == null ? void 0 : setting.data) == null ? void 0 : _c.metaobject) == null ? void 0 : _d.variant.value;
            return {
              collection,
              variant
            };
          ...
          if (curatedData.length > 0) {
            lineItemsData.map((line) => {
              const collectionList = (line == null ? void 0 : line.collections) || [];
              collectionList.map((collection) => __async(this, null, function* () {
                ...
                if (isFreeProductElible) {
                  ...
                  if (productAdded.find((id) => id == variantToAdd)) {
                    ...
                    yield handleAddToCart(variantToAdd);
                  }
                }
              }));
            });
    ...
    function updateCart(line) {
      return __async(this, null, function* () {
        const updateQuantity = yield applyCartLinesChange({
          type: "updateCartLine",
          id: `${line.id}`,
    ...
    function handleAddToCart(constiantId) {
      return __async(this, null, function* () {
        setAdding(true);
        ...
        if (result.type == "error") {
          setTimeout(() => __async(this, null, function* () {
            yield handleAddToCart(constiantId);
          }), 2e3);
        } else {
          return result;
        }
